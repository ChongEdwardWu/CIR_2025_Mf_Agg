...
# !需要手动设置的变量
DATASET_ID='SA2021_step2_Mf_seu'
WORKDIR="/ifs1/User/yangbinVM/01.Project/wuchong/data/WYL/HCC-sp-RNAseq"
AUXILLIARIES_FOLDERNAME="/ifs1/User/yangbinVM/01.Project/wuchong/Ref_genome/SCENIC/Human" #! change spesis if necessary!
...
MOTIF_ANNOTATIONS_FNAME=os.path.join(AUXILLIARIES_FOLDERNAME,"motifs-v10nr_clust-nr.hgnc-m0.001-o0.0.tbl") # change spesis if necessary!
